...
-- File này ĐÃ BAO GỒM lệnh tạo bảng bị thiếu
-- Chạy file này sẽ không bị lỗi "Table doesn't exist"
-- ============================================

-- Chọn database (Bạn nhớ thay tên database nếu khác)
USE hotel_booking; 
...
-- ============================================
-- PART 1: TẠO CÁC BẢNG CHÍNH (PHẦN BỊ THIẾU TRƯỚC ĐÂY)
-- ============================================
...
CREATE TABLE IF NOT EXISTS hotel (
    ...
    owner_user BIGINT,
    CONSTRAINT fk_hotel_owner FOREIGN KEY (owner_user) REFERENCES users(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS hotel_reviews (
    ...
    hotel_id BIGINT,
    user_id BIGINT,
    CONSTRAINT fk_reviews_hotel FOREIGN KEY (hotel_id) REFERENCES hotel(id),
...
CREATE TABLE IF NOT EXISTS booking (
    ...
    CONSTRAINT fk_booking_room FOREIGN KEY (rooms_id) REFERENCES rooms(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


-- ============================================
-- PART 2: TẠO CÁC BẢNG PHỤ (INFO/ABOUT/CONTACT)
-- ============================================
...
-- Rooms for Majestic Saigon Hotel
...
-- Rooms for Liberty Central Saigon
...
-- Rooms for Mia Resort Nha Trang
...
-- Rooms for Four Seasons Resort Hoi An
...
-- Rooms for Palm Garden Beach Resort
...
-- Rooms for Hoi An Riverside Resort
